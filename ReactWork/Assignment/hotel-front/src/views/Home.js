...
const Home = () => {
    useEffect(() => {
      document.body.className = "home wp-singular page-template page-template-template-layout-builder page-template-template-layout-builder-php page page-id-32 wp-theme-kinsley wp-child-theme-kinsley-child theme-kinsley woocommerce-no-js elementor-default elementor-kit-5762 elementor-page elementor-page-32";
      return () => document.body.className = "";
    }, []);

    return(
    <>
          <div id="post-32" className="post-32 page type-page status-publish hentry">
        <div
                    ...
                    <div className="elementor-widget-container">
                      ...
                      <section className="knsl-banner">
                        <div className="knsl-cover-frame">
                            <img decoding="async"
                            src="../assets/wp-content/uploads/2021/08/img-banner-2-scaled-1-1920x1315.jpg"
                            alt="Image" class="knsl-parallax lazyload"/>
                          
                        </div>
                        <div className="knsl-overlay" style={{ opacity: 1 }} />
                            ...
                            <div className="knsl-main-title">
                              <div className="knsl-white">
                                ...
                                <div className="knsl-main-title--d knsl-mb-30 knsl-center">
                                  <span>                                    
                                    Deleniti nostrum laboriosam praesentium quasi
                                    quam voluptate.
                                  </span>
                                </div>
                              </div>
                              ...
                              <div className="mphb_sc_search-wrapper ">
                                ...
                                >
                                  ...
                                  <p className="mphb_sc_search-check-in-date">
                                    ...
                                    <label htmlFor="mphb_check_in_date-mphb-search-form-686525826641e">
                                      Check-in
                                    ...
                                    <br />
                                    <input
                                      id="mphb_check_in_date-mphb-search-form-686525826641e"
                                      data-datepick-group="mphb-search-form-686525826641e"
                                      defaultValue=""
                                  ...
                                  <p className="mphb_sc_search-check-out-date">
                                    ...
                                    <label htmlFor="mphb_check_out_date-mphb-search-form-686525826641e">
                                      Check-out
                                      <abbr title="Formatted as dd/mm/yyyy">
                                        *
                                      </abbr>
                                    ...
                                    <br />
                                    <input
                                      id="mphb_check_out_date-mphb-search-form-686525826641e"
                                      data-datepick-group="mphb-search-form-686525826641e"
                                      defaultValue=""
                                  ...
                                  <p className="mphb_sc_search-adults">
                                    ...
                                    <label htmlFor="mphb_adults-mphb-search-form-686525826641e">
                                      Adults
                                    </label>
                                    <br />
                                    <select
                                      id="mphb_adults-mphb-search-form-686525826641e"
                                      name="mphb_adults"
                                    >
                                  ...
                                  <p className="mphb_sc_search-children">
                                    ...
                                    <label htmlFor="mphb_children-mphb-search-form-686525826641e">
                                      Children
                                    </label>
                                    <br />
                                    <select
                                      id="mphb_children-mphb-search-form-686525826641e"
                                      name="mphb_children"
                                    >
                                  ...
                                  <input
                                    id="mphb_check_in_date-mphb-search-form-686525826641e-hidden"
                                    defaultValue=""
                                    type="hidden"
                                    name="mphb_check_in_date"
                                  />
                                  <input
                                    id="mphb_check_out_date-mphb-search-form-686525826641e-hidden"
                                    defaultValue=""
                                    type="hidden"
                                    name="mphb_check_out_date"
                                  />
                                ...
                                <div className="knsl-about-text">
                                  <div className="knsl-title-frame">
                                    <h2 className="knsl-mb-20">
                                      ...
                                      <span> Start your Amazing Adventure! </span>
                                    </h2>
                                    <div className="knsl-text knsl-mb-30">
                                      <div>
                                        <p>
                                ...
                                <div className="knsl-text knsl-mb-30">
                                  <p>
                                    ...
                                    <span>
                                      ...
                                      voluptatem. Laborum accusantium libero
                              ...
                              <div className="knsl-ath-card ">
                                ...
                                <div className="knsl-card-description">
                                  ...
                                  <div className="knsl-text knsl-text--h">
                                    <p>
                                      Image for cattle earth. May one Which life
                                ...
                                <div className="knsl-cover-frame">
                                  ...
                                  <div className="knsl-badge">
                                    <p className="mphb-price-wrapper">
                                      <strong>Price:</strong>
                                      <span className="mphb-price">
                                        <span className="mphb-currency">€</span>10
                                      </span>
                        ...
                        <div className="container">
                          <div className="row justify-content-center">
                            ...
                            <div className="col-lg-6">
                              ...
                              {/* slider */}
                              <div className="swiper-slider knsl-testimonials-slider knsl-scroll-animation swiper-initialized swiper-horizontal swiper-pointer-events swiper-autoheight swiper-watch-progress swiper-backface-hidden knsl-active-el">
                                <div className="swiper-wrapper">
                                  <div className="swiper-slide">
                                      ...
                                      <div className="knsl-name-and-text">
                                        ...
                                        <blockquote>
                                          ...
                                          <div>
                                            ...
                                            illo, delectus totam! Delectus illo
                                            magnam voluptatem a tempora id vitae
                                            dolor, quis natus iusto molestiae ab
                                            nam error vero possimus ullam facilis
                                            porro veritatis?
                                          </div>
                                        </blockquote>
                                      </div>
                                  ...
                                  <div className="knsl-cover-frame">
                                    ...
                                    <a href="2021/12/21/the-ultimate-guide-to-traveling-when-you-have-no-money-2/index.html">
                                      <noscript>
                                        ...
                                        alt="The Ultimate Guide to Traveling When
                                        You Have No Money" /&gt;
                                      </noscript>
                                      <img
                                        className="lazyload"
                                  ...
                                  <div className="knsl-description-frame">
                                    ...
                                    >
                                      <h4 className="knsl-mb-20">
                                        The Ultimate Guide to Traveling When You
                                        Have No Money
                                      </h4>
                                    </a>
                              ...
                              <div className="knsl-blog-card">
                                ...
                                >
                                  <div className="knsl-cover-frame">
                                    ...
                                    <a href="2021/12/21/the-best-travel-insurance-companies-for-seniors-2/index.html">
                                      <noscript>
                                        ...
                                        alt="The Best Travel Insurance Companies
                                        for Seniors" /&gt;
                                      </noscript>
                                      <img
                                        className="lazyload"
                                  ...
                                  <div className="knsl-description-frame">
                                    ...
                                    >
                                      <h4 className="knsl-mb-20">
                                        The Best Travel Insurance Companies for
                                        Seniors
                                      </h4>
                                    </a>
                                    <div className="knsl-text-light knsl-text-sm">
                                  ...
                                  <div className="knsl-cover-frame">
                                    ...
                                    <a href="2021/12/21/18-easy-steps-for-planning-your-next-trip-2/index.html">
                                      <noscript>
                                        ...
                                        alt="18 Easy Steps for Planning Your Next
                                        Trip" /&gt;
                                      </noscript>
                                      <img
                                        className="lazyload"
