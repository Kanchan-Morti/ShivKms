...
const Room3 = () => {
  useEffect(() => {
    document.body.className =
      "wp-singular page-template page-template-template-layout-builder page-template-template-layout-builder-php page page-id-7017 wp-theme-kinsley wp-child-theme-kinsley-child theme-kinsley woocommerce-no-js elementor-default elementor-kit-5762 elementor-page elementor-page-7017";
  ...
  return (
    <>
      <>
        <div
          id="post-7017"
          className="post-7017 page type-page status-publish hentry">
          <div
            data-elementor-type="wp-page"
            data-elementor-id={7017}
            className="elementor elementor-7017">
            <section
              className="elementor-section elementor-top-section elementor-element elementor-element-40cb970 elementor-section-full_width elementor-section-height-default elementor-section-height-default"
              data-id="40cb970"
              data-element_type="section">
              <div className="elementor-container elementor-column-gap-no">
                <div
                  className="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-0a0c4ad"
                  data-id="0a0c4ad"
                  data-element_type="column">
                  <div className="elementor-widget-wrap elementor-element-populated">
                    <div
                      className="elementor-element elementor-element-a0dfb3d elementor-widget elementor-widget-kinsley-intro"
                      data-id="a0dfb3d"
                              ...
                              <div className="col-lg-12">
                                <div className="knsl-center knsl-title-frame">
                                  ...
                                  <p className="knsl-text knsl-mb-30">
                                    ...
                                    <span>
                                      {" "}
                                      Laborum accusantium libero commodi.
                                      Voluptate consequatur itaque expedita
                                      accusamus impedit perspiciatis asperiores
            ...
            <section
              className="elementor-section elementor-top-section elementor-element elementor-element-38d8562 elementor-section-boxed elementor-section-height-default elementor-section-height-default"
              data-id="38d8562"
              data-element_type="section">
              <div className="elementor-container elementor-column-gap-default">
                <div
                  className="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-b55ae80"
                  data-id="b55ae80"
                  data-element_type="column">
                  <div className="elementor-widget-wrap elementor-element-populated">
                    <div
                      className="elementor-element elementor-element-771103f elementor-widget elementor-widget-kinsley-mphb-search-form"
                      data-id="771103f"
                      data-element_type="widget"
                      data-widget_type="kinsley-mphb-search-form.default">
                      <div className="elementor-widget-container">
                        <div className="mphb_sc_search-wrapper  knsl-book-form knsl-book-form-2">
                          <form
                            method="GET"
                            ...
                            <p className="mphb_sc_search-check-in-date">
                              {" "}
                              <label htmlFor="mphb_check_in_date-mphb-search-form-686525a303bd8">
                                Check-in{" "}
                                <abbr title="Formatted as dd/mm/yyyy">*</abbr>{" "}
                              </label>
                              <br />{" "}
                              <input
                                id="mphb_check_in_date-mphb-search-form-686525a303bd8"
                                data-datepick-group="mphb-search-form-686525a303bd8"
                                defaultValue=""
                            ...
                            <p className="mphb_sc_search-check-out-date">
                              {" "}
                              <label htmlFor="mphb_check_out_date-mphb-search-form-686525a303bd8">
                                Check-out{" "}
                                <abbr title="Formatted as dd/mm/yyyy">*</abbr>
                              </label>{" "}
                              <br />{" "}
                              <input
                                id="mphb_check_out_date-mphb-search-form-686525a303bd8"
                                data-datepick-group="mphb-search-form-686525a303bd8"
                                defaultValue=""
                            ...
                            <p className="mphb_sc_search-adults">
                              {" "}
                              <label htmlFor="mphb_adults-mphb-search-form-686525a303bd8">
                                {" "}
                                Adults
                              </label>{" "}
                              <br />{" "}
                              <select
                                id="mphb_adults-mphb-search-form-686525a303bd8"
                                name="mphb_adults">
                            ...
                            <p className="mphb_sc_search-children">
                              {" "}
                              <label htmlFor="mphb_children-mphb-search-form-686525a303bd8">
                                {" "}
                                Children
                              </label>{" "}
                              <br />{" "}
                              <select
                                id="mphb_children-mphb-search-form-686525a303bd8"
                                name="mphb_children">
                            ...
                            <input
                              id="mphb_check_in_date-mphb-search-form-686525a303bd8-hidden"
                              defaultValue=""
                              type="hidden"
                              name="mphb_check_in_date"
                            />
                            <input
                              id="mphb_check_out_date-mphb-search-form-686525a303bd8-hidden"
                              defaultValue=""
                              type="hidden"
                              name="mphb_check_out_date"
                            />
            ...
            <section
              className="elementor-section elementor-top-section elementor-element elementor-element-0832fbb elementor-section-full_width elementor-section-height-default elementor-section-height-default"
              data-id="0832fbb"
              data-element_type="section">
              <div className="elementor-container elementor-column-gap-no">
                <div
                  className="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-c2fd55a"
                  data-id="c2fd55a"
                  data-element_type="column">
                  <div className="elementor-widget-wrap elementor-element-populated">
                    <div
                      className="elementor-element elementor-element-f6c9a27 elementor-widget elementor-widget-kinsley-rooms-grid"
                      data-id="f6c9a27"
                      data-element_type="widget"
                      ...
                      <div className="elementor-widget-container">
                        ...
                        <section className="knsl-p-0-100">
                          ...
                          />
                          <div className="container">
                            <div className="row attr-details-amenity-false attr-details-category-false attr-details-attributes-false attr-details-view-false attr-details-bed-type-false attr-details-children-false mphb-room-type-inline">
                              <div className="col-lg-12 ">
                                <div className="mphb_sc_room-wrapper ">
                                  <div className="mphb-room-type post-1943 mphb_room_type type-mphb_room_type status-publish has-post-thumbnail mphb_room_type_category-economy mphb_room_type_tag-city mphb_room_type_tag-economy mphb_room_type_facility-4-private-pools mphb_room_type_facility-air-conditioning mphb_room_type_facility-airport-transfer mphb_room_type_facility-all-inclusive mphb_room_type_facility-wifi mphb_room_type_facility-laundry mphb_room_type_facility-smart-tv mphb_room_type_facility-under-protection mphb-room-type-adults-2 mphb-room-type-children-1 ">
                                    <p className="post-thumbnail mphb-loop-room-thumbnail">
                                      {" "}
                                      <a href="../accommodation/economy-classic-room/index.html">
                                        <img decoding="async" width="1000"
                                          height="667"
                                          src="../assets/wp-content/uploads/2021/12/room-12.jpg"
                                          class="attachment-post-thumbnail
                                          size-post-thumbnail wp-post-image"
                                          alt=""
                                          srcset="https://kinsley.bslthemes.com/wp-content/uploads/2021/12/room-12.jpg
                                          1000w,
                                          https://kinsley.bslthemes.com/wp-content/uploads/2021/12/room-12-300x200.jpg
                                          300w,
                                          https://kinsley.bslthemes.com/wp-content/uploads/2021/12/room-12-768x512.jpg
                                          768w,
                                          https://kinsley.bslthemes.com/wp-content/uploads/2021/12/room-12-950x634.jpg
                                          950w,
                                          https://kinsley.bslthemes.com/wp-content/uploads/2021/12/room-12-800x534.jpg
                                        ...
                                        <img
                                          ...
                                          data-src="https://kinsley.bslthemes.com/wp-content/uploads/2021/12/room-12.jpg"
                                          className="lazyload attachment-post-thumbnail size-post-thumbnail wp-post-image"
                                          alt=""
                                          data-srcset="https://kinsley.bslthemes.com/wp-content/uploads/2021/12/room-12.jpg 1000w, https://kinsley.bslthemes.com/wp-content/uploads/2021/12/room-12-300x200.jpg 300w, https://kinsley.bslthemes.com/wp-content/uploads/2021/12/room-12-768x512.jpg 768w, https://kinsley.bslthemes.com/wp-content/uploads/2021/12/room-12-950x634.jpg 950w, https://kinsley.bslthemes.com/wp-content/uploads/2021/12/room-12-800x534.jpg 800w"
                                    ...
                                    <h2 className="mphb-room-type-title entry-title">
                                      ...
                                      <a
                                        ...
                                        href="../accommodation/economy-classic-room/index.html">
                                    ...
                                    <div className="knsl-text-light knsl-text-sm knsl-mb-20">
                                      <p>
                                        ...
                                        quibusdam fugit aspernatur cumque harum
                                        quos esse libero nesciunt, molestiae
                                        saepe, possimus a suscipit.
                                      </p>
                                    </div>
                                    ...
                                    <div className="mphb-to-book-btn-wrapper">
                                      <form
                                        action="https://kinsley.bslthemes.com/accommodation/economy-classic-room/#booking-form-1943"
                                        method="get">
                                        <button
                                          type="submit"
            ...
            <section
              className="elementor-section elementor-top-section elementor-element elementor-element-e50cd6a elementor-section-full_width elementor-section-height-default elementor-section-height-default"
              data-id="e50cd6a"
              data-element_type="section"
              data-settings='{"background_background":"classic"}'>
              <div className="elementor-container elementor-column-gap-no">
                <div
                  className="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-c7e937c"
                  data-id="c7e937c"
                  data-element_type="column">
                  <div className="elementor-widget-wrap elementor-element-populated">
                    <div
                      className="elementor-element elementor-element-8f02235 elementor-widget elementor-widget-kinsley-rooms-carousel"
                      data-id="8f02235"
                      data-element_type="widget"
            ...
            <section
              className="elementor-section elementor-top-section elementor-element elementor-element-9eca96a elementor-section-full_width elementor-section-height-default elementor-section-height-default"
              data-id="9eca96a"
              data-element_type="section"
              data-settings='{"background_background":"classic"}'>
              <div className="elementor-container elementor-column-gap-no">
                <div
                  className="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-1ea8f78"
                  data-id="1ea8f78"
                  data-element_type="column">
                  <div className="elementor-widget-wrap elementor-element-populated">
                    <div
                      className="elementor-element elementor-element-c85aa69 elementor-widget elementor-widget-kinsley-testimonials"
                      data-id="c85aa69"
                      data-element_type="widget"
                      ...
                      <div className="elementor-widget-container">
                        {" "}
                        {/* testimonials */}
                        <section className="knsl-transition-middle knsl-p-0-80">
                          {" "}
                          <img decoding="async"
                            src="../assets/wp-content/themes/kinsley/assets/img/palm.svg"
                            class="knsl-deco-left" alt="palm" />
