...
const Home2 = () => {
  useEffect(() => {
            document.body.className =
              "wp-singular page-template page-template-template-layout-builder page-template-template-layout-builder-php page page-id-1112 wp-theme-kinsley wp-child-theme-kinsley-child theme-kinsley woocommerce-no-js elementor-default elementor-kit-5762 elementor-page elementor-page-1112";
  ...
  return (
    <>
      <div
        id="post-1112"
        className="post-1112 page type-page status-publish hentry">
        <div
          data-elementor-type="wp-page"
          data-elementor-id={1112}
          className="elementor elementor-1112">
          <section
                    ...
                    <div className="elementor-widget-container">
                      ...
                      <section className="knsl-banner">
                        <div className="knsl-cover-frame">
                          <div
                            className="knsl-banner-slideshow swiper-container"
                            data-speed={1400}
                            data-delay={4000}>
                            {" "}
                            ...
                            <div className="swiper-wrapper">
                              ...
                              <div className="swiper-slide">
                                {" "}
                                <img decoding="async"
                                  src="../assets/wp-content/uploads/2021/12/img-banner-3-scaled-1-1920x950.jpg"
                                  alt="Slide #1" class="knsl-parallax"/>
                                <img
                                  decoding="async"
                                  src="data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%20210%20140%22%3E%3C/svg%3E"
                                  data-src="https://kinsley.bslthemes.com/wp-content/uploads/2021/12/img-banner-3-scaled-1-1920x950.jpg"
                                  alt="Slide #1"
                                  className="lazyload knsl-parallax"
                                />
                              </div>
                              <div className="swiper-slide">
                                {" "}
                                <img decoding="async"
                                  ...
                                  alt="Slide #2" class="knsl-parallax"/>
                                <img
                                  decoding="async"
                                  src="data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%20210%20140%22%3E%3C/svg%3E"
                              ...
                              <div className="swiper-slide">
                                ...
                                <img decoding="async"
                                  ...
                                  alt="Slide #3" class="knsl-parallax"/>
                                <img
                                  decoding="async"
                                  src="data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%20210%20140%22%3E%3C/svg%3E"
                        ...
                        <div
                          ...
                          style={{ opacity: "0.6" }}
                        />
                        <div className="knsl-banner-content knsl-p-40-0">
                          <div className="container">
                            <div className="row">
                              <div className="col-lg-8 align-self-center">
                                <div className="knsl-main-title knsl-mb-40">
                                  <div className="knsl-white">
                                    <ul className="knsl-stars knsl-stars-left">
                                      <li>
                                    ...
                                    {/* main-title */}
                                    <h1 className="knsl-main-title--h knsl-mb-10">
                                      {" "}
                                      <span>
                                        Welcome to Kinsley
                                        <br /> 5 star hotel{" "}
                                    ...
                                    <div className="knsl-main-title--d knsl-mb-30">
                                      {" "}
                                      <span>
                                        Deleniti nostrum laboriosam
                                        praesentium quasi quam voluptate.
                                        <br />
                                        Frycimus suscipit, nam mollitia
                                        quidem.{" "}
                                      </span>
                                    </div>
                                    <div className="knsl-scroll-hint-frame knsl-scroll-hint-left">
                                      <a
                                        href="#knsl-triger-1"
                              ...
                              <div className="col-lg-4">
                                <div className="knsl-book-form knsl-book-form-v">
                                  <div className="mphb_sc_search-wrapper ">
                                    <form
                                      ...
                                      <p className="mphb_sc_search-check-in-date">
                                        {" "}
                                        <label htmlFor="mphb_check_in_date-mphb-search-form-6865259e044ac">
                                          Check-in{" "}
                                        ...
                                        <br />{" "}
                                        <input
                                          id="mphb_check_in_date-mphb-search-form-6865259e044ac"
                                          data-datepick-group="mphb-search-form-6865259e044ac"
                                          defaultValue=""
                                      ...
                                      <p className="mphb_sc_search-check-out-date">
                                        {" "}
                                        <label htmlFor="mphb_check_out_date-mphb-search-form-6865259e044ac">
                                          Check-out{" "}
                                          <abbr title="Formatted as dd/mm/yyyy">
                                            *
                                          </abbr>
                                        ...
                                        <br />{" "}
                                        <input
                                          id="mphb_check_out_date-mphb-search-form-6865259e044ac"
                                          data-datepick-group="mphb-search-form-6865259e044ac"
                                          defaultValue=""
                                      ...
                                      <p className="mphb_sc_search-adults">
                                        {" "}
                                        <label htmlFor="mphb_adults-mphb-search-form-6865259e044ac">
                                          Adults{" "}
                                        </label>{" "}
                                        <br />{" "}
                                        <select
                                          id="mphb_adults-mphb-search-form-6865259e044ac"
                                          name="mphb_adults">
                                          <option
                                            value={1}
                                            selected="selected">
                                      ...
                                      <p className="mphb_sc_search-children">
                                        {" "}
                                        <label htmlFor="mphb_children-mphb-search-form-6865259e044ac">
                                          Children{" "}
                                        </label>{" "}
                                        <br />{" "}
                                        <select
                                          id="mphb_children-mphb-search-form-6865259e044ac"
                                          name="mphb_children">
                                          <option
                                            value={0}
                                            selected="selected">
                                      ...
                                      <input
                                        id="mphb_check_in_date-mphb-search-form-6865259e044ac-hidden"
                                        defaultValue=""
                                        type="hidden"
                                        name="mphb_check_in_date"
                                      />
                                      <input
                                        id="mphb_check_out_date-mphb-search-form-6865259e044ac-hidden"
                                        defaultValue=""
                                        type="hidden"
                                        name="mphb_check_out_date"
                                      />
                                  ...
                                  <div className="swiper-slide">
                                    ...
                                    <div className="knsl-image-frame">
                                      ...
                                      <a
                                        ...
                                        href="../wp-content/uploads/2021/09/about-1.jpg">
                                        <noscript>
                                          &lt;img decoding="async"
                                  ...
                                  <div className="swiper-slide">
                                    ...
                                    <div className="knsl-image-frame">
                                      ...
                                      <a
                                        ...
                                        href="../wp-content/uploads/2021/09/about-2.jpg">
                                        <noscript>
                                          &lt;img decoding="async"
                                  ...
                                  <div className="swiper-slide">
                                    ...
                                    <div className="knsl-image-frame">
                                      ...
                                      <a
                                        ...
                                        href="../wp-content/uploads/2021/09/about-3.jpg">
                                        <noscript>
                                          &lt;img decoding="async"
                                  ...
                                  <div className="swiper-slide">
                                    ...
                                    <div className="knsl-image-frame">
                                      ...
                                      <a
                                        ...
                                        href="../wp-content/uploads/2021/09/about-4.jpg">
                                        <noscript>
                                          &lt;img decoding="async"
                                  ...
                                  <div className="swiper-slide">
                                    ...
                                    <div className="knsl-image-frame">
                                      ...
                                      <a
                                        data-elementor-lightbox-slideshow="about-gallery-4b38713"
                                        data-elementor-lightbox-title="East terrace"
                                        href="../wp-content/uploads/2021/09/about-5.jpg">
                                        <noscript>
                                          &lt;img decoding="async"
                                          src="../assets/wp-content/uploads/2021/09/about-5.jpg"
                                          alt="East terrace" /&gt;
                                  ...
                                  <div className="swiper-slide">
                                    ...
                                    <div className="knsl-image-frame">
                                      ...
                                      <a
                                        data-elementor-lightbox-slideshow="about-gallery-4b38713"
                                        data-elementor-lightbox-title="West terrace"
                                        href="../wp-content/uploads/2021/09/about-6.jpg">
                                        <noscript>
                                          &lt;img decoding="async"
                                          src="../assets/wp-content/uploads/2021/09/about-6.jpg"
                                          alt="West terrace" /&gt;
                                  ...
                                  <div className="swiper-slide">
                                    ...
                                    <div className="knsl-image-frame">
                                      ...
                                      <a
                                        data-elementor-lightbox-slideshow="about-gallery-4b38713"
                                        data-elementor-lightbox-title="View from the sea"
                                        href="../wp-content/uploads/2021/09/about-7.jpg">
                                        <noscript>
                                          &lt;img decoding="async"
                                  ...
                                  <div className="swiper-slide">
                                    ...
                                    <div className="knsl-image-frame">
                                      ...
                                      <a
                                        data-elementor-lightbox-slideshow="about-gallery-4b38713"
                                        data-elementor-lightbox-title="East terrace"
                                        href="../wp-content/uploads/2021/09/about-8.jpg">
                                        <noscript>
                                          &lt;img decoding="async"
